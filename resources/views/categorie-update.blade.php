            ...
            <div class="col-md-6">
                <div class="card mt-5" >
                    ...
                    <div class="card-body">
                        ...
                        <form action="/categorie/update/{{ $categorie->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group pt-2">
                                <label for="productName">Nama Produk</label>
                                <input type="text" name="nama_categorie" class="form-control" id="productName" placeholder="Masukkan nama produk" value="{{ $categorie->nama_categorie }}">
                            </div>
