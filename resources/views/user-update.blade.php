                    ...
                    <div class="card-body">
                        ...
                        <form action="/user/update/{{ $user->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="text" name="name" class="form-control" id="productName" placeholder="Masukkan nama produk" value="{{ $user->name }}">
                            </div>
                            {{-- <div class="form-group pt-2">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="email" name="email" class="form-control" id="price" placeholder="Masukkan harga produk" value="{{ $user->email }}">
                            </div>
                            <tr class="mb-3">
