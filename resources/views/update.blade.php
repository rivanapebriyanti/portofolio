            ...
            <div class="col-md-6">
                <div class="card mt-5" >
                    ...
                    <div class="card-body">
                        ...
                        <form action="/home/update/{{ $produk->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <tr class="mb-3">
                                <td class="form-label">categorie</td>
                                <td>
                                    <select name="categories_id" id="" class="form-select border-dark">
                                        @foreach ($categorie as $item)
                                        <option value="{{$item->id}}"{{$item->id==$produk->categories_id?'selected':''}}>{{$item->nama_categorie}}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
