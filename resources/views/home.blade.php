        ...
        <div class="container-fluid  service py-5">
            <div class="container py-5">
                ...
                <div class="row g-4">
                    {{-- <div class="col-lg-6"> --}}
                        <div class="row g-4">
                            <a class="col-4" href="/user">
                                <div class="service-content-inner d-flex align-items-center bg-white border rounded p-4 pe-0">
                                    <div class="service-content text-center">
                                        <h5 class="mb-4">LIHAT DATA USER</h5>
                                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi iusto ex labore sunt voluptatibus soluta nulla eos libero dolor officia.
                                        </p>
                                    </div>
                            ...
                            <a class="col-4" href="/produk">
                                <div class="service-content-inner d-flex align-items-center  bg-white border rounded p-4 pe-0">
                                    <div class="service-content text-center">
                                        <h5 class="mb-4">LIHAT DATA PRODUK</h5>
                                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum maxime minima tempora tempore culpa distinctio nobis debitis aperiam hic quia.
                                        </p>
                                    </div>
                                    <div class="service-icon p-4">
                            ...
                            <a class="col-4" href="/categorie">
                                <div class="service-content-inner d-flex align-items-center bg-white border rounded p-4 pe-0">
                                    <div class="service-content text-center">
                                        <h5 class="mb-4">LIHAT DATA CATEGORIE</h5>
                                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi iusto ex labore sunt voluptatibus soluta nulla eos libero dolor officia.
                                        </p>
                                    </div>
                                    <div class="service-icon p-4">
        ...
        <footer class="footer-section">
			<div class="container relative">
				<div class="row g-5 mb-5">
					<div class="col-lg-4">
						<div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">BedStore<span>.</span></a></div>
						<p class="mb-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, ipsa. Amet modi nulla voluptate! Hic.t</p>
