...
<head>
    ...
    <div class="container py-5" style="margin-top: 8%">
        <div class="text-center mb-5">
            <h1 style="color: #3b5d50;">Kontak & Media Sosial Kami</h1>
            <p class="lead">Ikuti kami di platform media sosial dan hubungi kami untuk informasi lebih lanjut</p>
        </div>
        <div class="col-lg-12 mx-auto">
            <div class="pengumuman-content-inner d-flex align-items-center bg-light border rounded" style=" border-color: #13357B">
                ...
                <div class="pengumuman-content ps-3">
                    <a href="https://www.instagram.com/osis.smkypc/?hl=en">https://www.instagram.com/rivanaapp/profilecard/?igsh=MXdlN2l5cG9hZjFyMA==</a>
                </div>
            </div>
            <div class="pengumuman-content-inner d-flex align-items-center bg-light border rounded mt-4" style=" border-color: #13357B">
                ...
                <div class="pengumuman-content ps-3">
                    <a href="http://www.youtube.com/@osis.smkypc">http://www.youtube.com/@rivanapebriyanti6055</a>
                </div>
            </div>
            <div class="pengumuman-content-inner d-flex align-items-center bg-light border rounded mt-4" style=" border-color: #13357B">
                <div class="pengumuman-icon p-4">
                ...
                <div class="pengumuman-content ps-3">
                    <a href="tel:+628112224">+62 831-9454-1571</a>
                </div>
            </div>
            <div class="pengumuman-content-inner d-flex align-items-center bg-light border rounded mt-4" style=" border-color: #13357B">
                <div class="pengumuman-icon p-4">
