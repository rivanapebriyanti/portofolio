                    ...
                    <div class="card-body">
                        <form action="/user/create" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="text" name="name" class="form-control" id="userName" placeholder="Masukkan Nama" >
                            </div>
                            {{-- <div class="form-group pt-2">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="email" name="email" class="form-control" id="price" placeholder="Masukkan Email">
                            </div>
                            <div class="form-group pt-2">
                                <label for="price">Password</label>
                                <input type="password" name="password" class="form-control" id="price" placeholder="Masukkan Email">
                            </div>
                            <div class="form-group pt-2">
                                <label for="price">Alamat</label>
                                <input type="text" name="alamat" class="form-control" id="price" placeholder="Masukkan Email">
                            </div>
                            <div class="form-group pt-2">
                                <label for="price">No HP</label>
                                <input type="text" name="nohp" class="form-control" id="price" placeholder="Masukkan Email">
                            </div>
                            <tr class="mb-3">
                                <td class="form-label">Level</td>
                                <td><select name="levels_id" id="" class="form-select border-dark">
