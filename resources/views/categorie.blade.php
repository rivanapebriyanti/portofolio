...
@endif <br>
    ...
    <div class="container pt-5" style="margin-top: 100px">
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="/categorie/create" class="btn btn-primary">Tambah Data</a><br>
            </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $key+1 }}</td>
                    <td>{{ $item->nama_categorie }}</td> 
                    <td>
                        <a href="/categorie/delete/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')" class="btn btn-danger">Hapus</a>
                        <a href="/categorie/update/{{ $item->id }}" class="btn btn-info">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
