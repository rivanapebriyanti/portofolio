...
@endif <br>
    ...
    <div class="container pt-5" style="margin-top: 100px">
        ...
        {{-- Total Data Transaksi: {{ $total_transaksi }} --}}
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $key+1 }}</td>
                    <td><img src="{{ asset('storage/gambar/'.$item->produk->gambar) }}" alt="" style="width: 50px; height:50px"></td>
                    <td>{{ $item->nama }}</td>
                    ...
                    <td>{{ $item->note }}</td>
                    <td>
                        <a href="/transaksi/delete/{{ $item->id }}" onclick="return window.confirm('Yakin hapus data ini?')" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
